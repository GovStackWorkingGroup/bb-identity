---
description: >-
  These terms are defined as being common across all the ID-Related Building
  Blocks (Identity, Consent, E-Signature, and Wallet)
---
...
{% hint style="info" %}
See also related terminology for [Digital Credential](id-related-bb-common-terminology.md#digital-credential) and [Verifiable Credentials](id-related-bb-common-terminology.md#verifiable-credentials-vcs).
{% endhint %}
